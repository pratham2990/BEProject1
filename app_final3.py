...
ARM_READY  = [147, 127, 88, 90, 42]
ARM_LOWER  = [147, 177, 0, 90, 42]
ARM_LIFT   = [147, 18, 0, 90, 42]
ARM_CARRY  = [147, 18, 88, 90, 42]
...
def move_arm(position):
    ...
    for i in range(NUM_SERVOS):
        ...
        servo_angles[i] = position[i]

        pwm_val = map_angle_to_pwm(position[i])
